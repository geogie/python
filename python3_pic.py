...
# 解析图片列表
def get_girl_list():
    # 返回一个 response 对象 Left_bar->li->a->url
...
def get_girl_detail(url):
    # 返回一个 response 对象 scroll-img-cont->li->img->data-original
...
def save_image(img_url):
    ...
    f = open('/Users/george/python/Girl/%d.jpg' % t, 'ab')  # 存储图片，多媒体文件需要参数b（二进制文件）
